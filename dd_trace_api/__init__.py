...
class Span:
    ...
    def set_link(
        ...
        shared_state = {"api_return_value": retval, "stub_self": self}
        audit(
            _DD_HOOK_PREFIX + "Span.set_link",
            ([shared_state, trace_id, span_id], {"tracestate": tracestate, "flags": flags, "attributes": attributes}),
        )
        return retval
...
class HTTPPropagator:
    ...
    def inject(span_context: _Context, headers: Dict[str, str], non_active_span: Optional[Span] = None) -> None:
        ...
        shared_state = {"api_return_value": retval}
        audit(
            _DD_HOOK_PREFIX + "HTTPPropagator.inject",
            ([shared_state, span_context, headers], {"non_active_span": non_active_span}),
        )
        return retval
...
class Tracer:
    ...
    def start_span(
        self,
        name: str,
        child_of: Optional[Union[Span, _Context]] = None,
        ...
        shared_state = {"api_return_value": retval}
        audit(
            _DD_HOOK_PREFIX + "Tracer.start_span",
            (
                [shared_state, name],
                {
                    "child_of": child_of,
    ...
    def trace(
        ...
        shared_state = {"api_return_value": retval}
        audit(
            _DD_HOOK_PREFIX + "Tracer.trace",
            ([shared_state, name], {"service": service, "resource": resource, "span_type": span_type}),
        )
        return retval
    ...
    def wrap(
        ...
        shared_state = {"api_return_value": retval}
        audit(
            _DD_HOOK_PREFIX + "Tracer.wrap",
            ([shared_state], {"name": name, "service": service, "resource": resource, "span_type": span_type}),
        )
        return retval
...
class Pin:
    ...
    def clone(
        self, service: Optional[str] = None, tags: Optional[Dict[str, str]] = None, tracer: Tracer = None
    ) -> None:
        retval = None
        shared_state = {"api_return_value": retval}
